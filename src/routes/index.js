    ...
    <Routes>
      <Route element={<Protected />}>
        ...
        <Route path="/ticket-management" element={<MainLayout />}>
          ...
          <Route element={<ProtectedRoute element={<StaffTicketViewPage />} permissionCode={'inst_perm_staff_ticket_view'} module={"staff_tickets"} />}>
          ...
          <Route element={<ProtectedRoute element={<StudentTicketViewPage />} permissionCode={'inst_perm_student_ticket_view'} module={"Student Tickets"} />}>
