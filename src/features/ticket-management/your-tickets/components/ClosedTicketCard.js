...
import { Avatar, Box, Button, Card, CardContent, Grid, keyframes } from '@mui/material';
        ...
        <CardContent>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              ...
              <Button variant="contained" component={Link} to={`/ticket-management/your-ticket-view/${ticket?.uuid}`} state={{ id: ticket?.uuid}} href={`/ticket-management/your-ticket/${ticket?.uuid}`}>
                 View
              </Button>
          </Box>
        </CardContent>
