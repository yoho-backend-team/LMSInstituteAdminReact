                ...
                <CardContent>
                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <Box sx={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            <Box>
                                <Typography variant="h5">{ticket?.student?.first_name} {ticket?.student?.last_name}</Typography>
                    ...
                    <Typography sx={{ my: 4, color: 'text.main' }}>
                        {ticket?.query}
                    </Typography>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <Box sx={{ display: 'flex', alignItems: 'center' }}>
                            <CustomChip icon={<CrisisAlertIcon />} rounded size="small" skin="light" color={'error'} label={`Priority:${ticket?.priority}`} />

                            <CustomChip icon={<FileOpenIcon />} rounded size="small" skin="light" color={'warning'} label={`${ticket?.status}`} sx={{ ml: 2 }} />
                        </Box>
                        <Box sx={{ display: 'flex', alignItems: 'center' }}>
