...
const STUDENT_NOTIFICATION_API_ENDPOINT = `${process.env.REACT_APP_PUBLIC_API_URL}/api/platform/admin/StudentNotification-management/StudentNotification`;

export const getAllStudentNotifications = async () => {
  try {
