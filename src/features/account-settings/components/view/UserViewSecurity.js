        ...
        <Card>
          ...
          <CardContent>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <div>
                <IconButton size="small" aria-label="edit" sx={{ color: 'text.secondary' }} onClick={handleEditMobileNumberClickOpen}>
            ...
            <Divider sx={{ mt: (theme) => `${theme.spacing(0.75)} !important`, mb: (theme) => `${theme.spacing(4)} !important` }} />
