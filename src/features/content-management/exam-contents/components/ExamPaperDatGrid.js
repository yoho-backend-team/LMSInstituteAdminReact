...
import ExamPaperHeader from 'features/content-management/exam-contents/components/ExamPaperHeader';
...
const ExamPaper = () => {
  ...
  return (
    <>
      <ExamPaperHeader value={value} handleFilter={handleFilter} toggle={toggleAddUserDrawer} />
      <DataGrid
        autoHeight
        rowHeight={80}
        rows={users}
